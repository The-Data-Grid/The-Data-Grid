...
const query = {
    ...
    whereConditionObject: { 
        ...
        overlaps: '$(id:raw) && $(val)',
        geoContains: 'ST_Contains($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoCrosses: 'ST_Crosses($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoDisjoint: 'ST_Disjoint($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoWithinDistance: 'ST_DWithin($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))), $(additionalArg))',
        geoEquals: 'ST_Equals($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoIntersects: 'ST_Intersects($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoOverlaps: 'ST_Overlaps($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoTouches: 'ST_Touches($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
        geoWithin: 'ST_Within($(id:raw), ST_FlipCoordinates(ST_GeomFromGeoJSON($(val))))',
    },
