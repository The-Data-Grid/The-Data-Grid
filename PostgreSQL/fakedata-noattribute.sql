...
INSERT INTO factor_sink_faucet_brand
("factor_id",
"data_level")
VALUES
...
VALUES
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 1, 1, NOW(), 'Nice Sink!', 'Sandra', 2.71828),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 1, 2, NOW(), 'Alright Sink.', 'Sandra', 3),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 1, 3, NOW(), 'Sink!', 'Sandra', 4),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 1, 4, NOW(), 'Nice!', 'Sandra', 4.1828),

    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 2, 5, NOW(), NULL, 'Sandra', 7.28),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 2, 6, NOW(), NULL, 'Sandra', 1.828),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 2, 7, NOW(), NULL, 'Sandra', 3.71828),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 2, 8, NOW(), NULL, 'Sandra', 3.1415),

    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 9, NOW(), 'Nice Sink!', 'Mark', 2),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 10, NOW(), 'Alright Sink.', 'Mark', 2.1),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 11, NOW(), 'Sink!', 'Mark', 2.3),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 12, NOW(), 'Nice!', 'Mark', 2.909),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 13, NOW(), NULL, 'Mark', 4.88),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 14, NOW(), NULL, 'Mark', 1.02),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 15, NOW(), NULL, 'Mark', 1.1),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 16, NOW(), '1st', 'Mark', 2.9),

    -- different people observation the same sink
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 16, NOW(), '2nd', 'Juan', 1.02),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 16, NOW(), '3rd', 'Pablo', 1.1),
    (default, nextval('tdg_observation_count_observation_count_id_seq') - 1, 3, 16, NOW(), '4th', 'Jeremiah', 2.8);
