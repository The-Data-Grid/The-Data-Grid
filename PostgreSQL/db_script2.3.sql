...
ALTER TABLE audit_template ADD FOREIGN KEY (organization_id) REFERENCES organization;
ALTER TABLE audit_template ADD FOREIGN KEY (user_id) REFERENCES users;
ALTER TABLE audit_submission ADD FOREIGN KEY (organization_id) REFERENCES organization;
...
ALTER TABLE organization ADD FOREIGN KEY (community_id) REFERENCES item_community;

ALTER TABLE users ADD FOREIGN KEY (privilege_id) REFERENCES privilege;
ALTER TABLE users ADD FOREIGN KEY (organization_id) REFERENCES organization;

ALTER TABLE sop ADD FOREIGN KEY (organization_id) REFERENCES organization;
